...
public enum AllocationRule {
    FIRST_COME_FIRST_SERVED( "First-Come-First-Served" ), FIRST_COME_FIRST_SERVED_APPROVAL( "First-Come-First-Served with Approval" ), LEAST_USED( "Least Used" ), BALLOTING( "Balloting" ), NONE( "None" );
