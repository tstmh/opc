...
public class HRHUBJob implements IBatchJob {
	...
	public HRHUBJob() {
		config = ServiceConfig.getInstance().getHRInterfaceConfig(IHRService.HRHUB);
		logger = LoggerBuilder.getInstance().getLogger(JobType.HRHUB);
		codeMappingUtil = new CodeMappingUtil(ExternalSystemType.HRHUB, logger);
	}
	
	@Override
	public JobType getType() {
		return JobType.HRHUB;
	}
