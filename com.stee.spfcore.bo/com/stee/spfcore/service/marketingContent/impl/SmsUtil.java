...
public class SmsUtil {
	...
	private void buildSSLContext (String trustStoreFile, String trustStorePassword) {
		...
		try {
			...
			try {
				...
				logger.log(Level.SEVERE, "Failed to close FileInputStream", e);
			}
		}
	}
	...
	private void sendBatch (String smsContent, List<String> recipients, Map<String,String> smsStatusMap) {
		...
		try {
			...
			logger.log(Level.SEVERE, "Fail to send SMS:" + Util.replaceNewLine( smsContent ), e);
		}
	}
	...
	private void extractCodes (String response, Map<String,String> smsStatusMap) {
		...
		//below 3 features are added to pass the <Disable access to external entities in XML parsing.> vulnarability in sonarqube
