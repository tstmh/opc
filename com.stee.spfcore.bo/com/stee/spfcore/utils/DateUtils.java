...
public class DateUtils {
	...
	public static boolean isBeforeDay( final Calendar cal1, final Calendar cal2 ) {
        return (cal1.get(Calendar.YEAR) < cal2.get(Calendar.YEAR)) || ((cal1.get(Calendar.YEAR) == cal2.get(Calendar.YEAR))
	...
	public static boolean isAfterDay( final Calendar cal1, final Calendar cal2 ) {
        return (cal1.get(Calendar.YEAR) > cal2.get(Calendar.YEAR)) || ((cal1.get(Calendar.YEAR) == cal2.get(Calendar.YEAR)) && (cal1.get(Calendar.DAY_OF_YEAR) > cal2
                .get(Calendar.DAY_OF_YEAR)));
    }
