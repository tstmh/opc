...
public class Encipher {
	...
	private static final Logger logger = Logger.getLogger(Encipher.class.getName());
	...
	public Encipher (String encryptionKey) throws GeneralSecurityException {
	...
	public String encrypt(String unencryptedString) {
		...
		try {
			...
			encryptedString = new String(Base64.encodeBase64(encryptedText), StandardCharsets.UTF_8);
		} 
		catch (GeneralSecurityException exception) {
			logger.log(Level.SEVERE, "Unable to encrpt the string.", exception);
		}
	...
	public String decrypt(String encryptedString) {
		...
		try {
			...
			logger.log(Level.SEVERE, "Unable to decrypt the string.", exception);
		}
