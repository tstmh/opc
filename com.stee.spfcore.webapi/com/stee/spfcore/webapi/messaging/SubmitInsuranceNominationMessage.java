...
public class SubmitInsuranceNominationMessage extends AbstractMessage {
	
	private Membership membership;
	
	public SubmitInsuranceNominationMessage() {
		super(MessageId.SUBMIT_INSURANCE_NOMINATION);
	}
	
	public SubmitInsuranceNominationMessage(Membership membership) {
		super(MessageId.SUBMIT_INSURANCE_NOMINATION);
