...
public class WithdrawMembershipMessage extends AbstractMessage {
	
	private Membership membership;
	
	public WithdrawMembershipMessage() {
		super(MessageId.WITHDRAW_MEMBERSHIP);
	}
	
	public WithdrawMembershipMessage(Membership membership) {
		super(MessageId.WITHDRAW_MEMBERSHIP);
