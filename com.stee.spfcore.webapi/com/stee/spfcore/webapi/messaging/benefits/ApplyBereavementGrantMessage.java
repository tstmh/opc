...
public class ApplyBereavementGrantMessage extends AbstractMessage {
	
	private BereavementGrant bereavementGrant;
	
	public ApplyBereavementGrantMessage() {
		super(MessageId.APPLY_BEREAVEMENT_GRANT);
	}
	
	public ApplyBereavementGrantMessage(BereavementGrant bereavementGrant) {
		super(MessageId.APPLY_BEREAVEMENT_GRANT);
