...
public class ApplyWeddingGiftMessage extends AbstractMessage {
	
	private WeddingGift weddingGift;
	
	public ApplyWeddingGiftMessage() {
		super(MessageId.APPLY_WEDDING_GIFT);
	}
	
	public ApplyWeddingGiftMessage(WeddingGift weddingGift) {
		super(MessageId.APPLY_WEDDING_GIFT);
