...
public class RegisterCourseMessage extends AbstractMessage {

	private CourseParticipant participant;

	public RegisterCourseMessage () {
		super(MessageId.REGISTER_COURSE);
	}
	
	public RegisterCourseMessage (CourseParticipant participant) {
		super (MessageId.REGISTER_COURSE);
