...
public class UpdateGEApplicationMessage extends AbstractMessage {
	
	private GenericEventApplication application;
	
	public UpdateGEApplicationMessage() {
		super(MessageId.UPDATE_GENERIC_EVENT_APPLICATION);
	}
	
	public UpdateGEApplicationMessage (GenericEventApplication application) {
		super (MessageId.UPDATE_GENERIC_EVENT_APPLICATION);
