...
import com.stee.spfcore.webapi.model.vo.corporateCard.CardCollectionLessDetail;
...
public class CardBooking {
	...
	@Id
	@GenericGenerator( name = "CardBookingGenerator", strategy = "com.stee.spfcore.webapi.dao.utils.StringIdHibernateGenerator" )
    ...
    @Transient
    @XStreamOmitField
    private transient CardTypeDetail cardTypeDetail;
