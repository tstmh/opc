...
public class MailServer implements IMailServer {
    ...
    public void send( ElectronicMail email ) throws NotificationServiceException {
        ...
        try {
            ...
            if ( email.getAttachments().isEmpty() ) {
                ...
                for ( String filePath : email.getAttachments() ) {
                    ...
                    try {
                        ...
                        logger.log( Level.SEVERE, "Unable to attach the following file attachment to email:" + filePath.replace('\n', '_').replace('\r', '_') );
            ...
            throw new NotificationServiceException( "Fail to send email via SMTP: " + this.hostname + exception );
        }
    }
    ...
    public void send( BatchElectronicMail email ) throws NotificationServiceException {
        ...
        try {
            ...
            if ( email.getAttachments().isEmpty() ) {
                ...
                for ( String filePath : email.getAttachments() ) {
                    ...
                    try {
                        ...
                        logger.log( Level.SEVERE, "Unable to attach the following file attachment to email:" + filePath );
                        // Will allow the email to continue to send, even if file attachment error.
                        continue;
                    }
            ...
            List< List< InternetAddress >> ccAddresses = new ArrayList< List <InternetAddress> >();
            List< InternetAddress > ccSubList = new ArrayList<InternetAddress>(); 
    ...
    private List< List< InternetAddress >> convert( List< String > recipients ) throws AddressException {
        ...
        List< List< InternetAddress >> addresses = new ArrayList< List< InternetAddress >>();
