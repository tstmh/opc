package com.stee.spfcore.webapi.utils.rest;
...
public class RESTInvoker {
	...
	public String get(String path, String acceptType) throws RESTInvocationException {
		...
		try {
			...
			logger.log(Level.WARNING, "Malformed URL:" + baseUrl + path, e);
			throw new RESTInvocationException ("Failed to invoke GET REST Service: " + baseUrl + path, e);
		} catch (IOException e) {

			logger.log(Level.WARNING, "Fail to get response from " + baseUrl + path, e);
			throw new RESTInvocationException ("Failed to invoke GET REST Service: " + baseUrl + path, e);
	...
	public void getAsFile(String path, String folder, String filename) throws RESTInvocationException {
		...
		try {
			...
			logger.log(Level.WARNING, "Malformed URL:" + baseUrl + Util.replaceNewLine( path ), e);
			throw new RESTInvocationException ("Failed to invoke GET REST Service: " + baseUrl + path, e);
		} catch (IOException e) {

			logger.log(Level.WARNING, "Fail to get response from " + baseUrl + Util.replaceNewLine( path ), e);
			throw new RESTInvocationException ("Failed to invoke GET REST Service: " + baseUrl + path, e);
	...
	public void delete (String path) throws RESTInvocationException {
		...
		try {
			...
			logger.log(Level.WARNING, "Malformed URL:" + baseUrl + path, e);
			throw new RESTInvocationException("Failed to invoke DELETE REST Service: " + baseUrl + path, e);
		} catch (IOException e) {
	...
	public String post (String contentType, String content) throws RESTInvocationException {
		...
		try {
			...
			logger.log(Level.WARNING, "Malformed URL:" + baseUrl, e);
			throw new RESTInvocationException ("Failed to invoke GET REST Service: " + baseUrl, e);
		} 
		catch (IOException e) {

			logger.log(Level.WARNING, "Fail to get response from " + baseUrl, e);
			throw new RESTInvocationException ("Failed to invoke GET REST Service: " + baseUrl, e);
